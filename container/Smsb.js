...
import SmsbReg from './SmsbReg'
import classNames from 'classnames/bind'
class Smsb extends Component {
    ...
    setCurrent(index){
        ...
        switch (index){
            case 1:
                 router.push('/index/pullb/smsb/reg')
                break
            case 2:
                 router.push('/index/pullb/smsb/add')
                break
            case 3:
                 router.push('/index/pullb/smsb/history')
                break
            case 4:
                 router.push('/index/pullb/smsb/model')
                break
            default :
                return
        }
    ...
    render(){
        return(
            <div>
                ...
                <div>{this.props.children||<SmsbReg/>}</div>
            </div>
        )
    }
}
